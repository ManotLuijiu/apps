...
export const MailchimpAuthSection = () => {
  ...
  console.log("mailchimp-auth-section.tsx_appBridgeContext", appBridgeContext?.token);
  console.log("mailchimp-auth-section.tsx_appBridgeContext", appBridgeContext?.saleorApiUrl);
